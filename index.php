...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="77">
    <nav class="navbar navbar-light navbar-expand-md fixed-top" id="mainNav">
        <div class="container"><a class="navbar-brand" href="#">Outils de presentation&nbsp;</a><button data-bs-toggle="collapse" class="navbar-toggler navbar-toggler-right" data-bs-target="#navbarResponsive" type="button" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation" value="Menu"><i class="fa fa-bars"></i></button>
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item nav-link"><a class="nav-link" href="#infoCollect">Collecte d'info</a></li>
                    <li class="nav-item nav-link"><a class="nav-link" href="#finalrapport">rapport Final</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        ...
                        <p class="intro-text">Bienvenue sur l'outil de présentation de situiation Géopolitique, cette outil permet une prise de notes rapides, il permet également de trier les différentes notes et intègre un module de collecte d’informations MultiCanal(Twitter, Google, Flux RSS de journaux)&nbsp; &nbsp;</p><a class="btn btn-link btn-circle" role="button" href="#about"><i class="fa fa-angle-double-down animated"></i></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <br><br>
                    ...
                    <br>
                        ...
                        <br>
                        <blockquote class="twitter-tweet"><p lang="en" dir="ltr">Call it wishful thinking, but what if <a href="https://twitter.com/hashtag/Putin?src=hash&amp;ref_src=twsrc%5Etfw">#Putin</a>’s end is closer than we think? And that he just MAY be digging his own grave in <a href="https://twitter.com/hashtag/Ukraine?src=hash&amp;ref_src=twsrc%5Etfw">#Ukraine</a>? Comments by myself &amp; <a href="https://twitter.com/Nigelgd1?ref_src=twsrc%5Etfw">@Nigelgd1</a>, <a href="https://twitter.com/TanyaKozyreva?ref_src=twsrc%5Etfw">@TanyaKozyreva</a>, <a href="https://twitter.com/emilavdaliani?ref_src=twsrc%5Etfw">@emilavdaliani</a> in this <a href="https://twitter.com/YahooNews?ref_src=twsrc%5Etfw">@YahooNews</a> article on 🇷🇺 &amp; 🇺🇦 by <a href="https://twitter.com/melissarossi199?ref_src=twsrc%5Etfw">@melissarossi199</a>. <a href="https://t.co/ProSMFZ8Z1">https://t.co/ProSMFZ8Z1</a></p>&mdash; Roland Freudenstein (@RoFreudenstein) <a href="https://twitter.com/RoFreudenstein/status/1483793571018854410?ref_src=twsrc%5Etfw">January 19, 2022</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script> 
